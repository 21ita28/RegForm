               ...
               <div className="row g-3">
                <div className="col-md-8">
                  ...
                  <div className="col-md-4">
                    ...
                    <input type="date" className="form-control" name="dob" min="1990-01-01" max="2012-12-31" onFocus={() => { 
        const today = new Date().toISOString().split('T')[0]; 
        document.getElementById('sDob').setAttribute('max', today);
    }} id="sDob" value={sDob} onChange={sDobHandle}></input>
                    ...
                    {insertform && sDob > '2012-12-31' && (
                    <div>
                      <label className="text-danger">Date Of Birth should not be later than 2012-12-31</label>
                    </div>
                      )}
                </div>
                </div>
